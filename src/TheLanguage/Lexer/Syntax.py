...
with InitRelativeImports():
    ...
    from .TranslationUnitLexer import DynamicPhrasesInfo
...
class SyntaxInvalidVersionFormatError(LexerError):
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class SyntaxInvalidVersionError(LexerError):
...
# ----------------------------------------------------------------------
class Observer(TranslationUnitsLexerObserver):
    ...
    def _SetSyntax(
        ...
        data = cast(Phrase.MultipleStandardLexResultData, data)
