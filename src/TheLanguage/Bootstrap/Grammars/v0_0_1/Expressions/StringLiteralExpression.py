...
# |
# ----------------------------------------------------------------------
"""Contains the StringLiteralExpression object"""
...
# ----------------------------------------------------------------------
class StringLiteralExpression(GrammarPhrase):
    """\
    ...
    PHRASE_NAME                             = "String Literal Expression"

    # ----------------------------------------------------------------------
    def __init__(self):
        super(StringLiteralExpression, self).__init__(
