...
class PatchAndExecuteFlag(Flag):
    prune_flag                              = auto()
    parse_flag                              = auto()
    validate_expression_types_flag          = auto()

    Lex                                     = 0
    Prune                                   = prune_flag
    Parse                                   = Prune | parse_flag
    ValidateExpressionTypes                 = Parse | validate_expression_types_flag
...
def PatchAndExecute(
    ...
    flag=PatchAndExecuteFlag.ValidateExpressionTypes,
    *,
    ...
    :
        ...
        if flag & PatchAndExecuteFlag.validate_expression_types_flag:
            results = ValidateExpressionTypes(
                results,
                {}, # TODO
                max_num_threads=max_num_threads,
