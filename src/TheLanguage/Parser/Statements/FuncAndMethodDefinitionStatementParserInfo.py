# ----------------------------------------------------------------------
# |
# |  FuncAndMethodDefinitionStatementParserInfo.py
# |
...
# |
# ----------------------------------------------------------------------
"""Contains the FuncAndMethodDefinitionStatementParserInfo object and exceptions"""
...
with InitRelativeImports():
    from .ClassStatementParserInfo import ClassStatementParserInfo, MethodType
...
class InvalidFunctionMethodTypeError(ParserError):
    MethodType: str
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class InvalidFunctionClassModifierError(ParserError):
    MessageTemplate                         = Interface.DerivedProperty(  # type: ignore
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class FunctionStatementsRequiredError(ParserError):
    MessageTemplate                         = Interface.DerivedProperty(  # type: ignore
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class MethodStatementsRequiredError(ParserError):
    MethodType: str
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class MethodStatementsUnexpectedError(ParserError):
    MethodType: str
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class InvalidMethodTypeError(ParserError):
    ClassType: str
    MethodType: str
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class InvalidClassModifierOnStaticError(ParserError):
    MessageTemplate                         = Interface.DerivedProperty(  # type: ignore
...
class FuncAndMethodDefinitionStatementParserInfo(StatementParserInfo):
    ...
    Parameters: Optional[ParameterParserInfo] # TODO: Update this
    ...
    def __post_init__(
        ...
        super(FuncAndMethodDefinitionStatementParserInfo, self).__post_init__(
            regions,
