...
class TestLineInfo(object):
    ...
    def test_StandardWithIndentation(self):
        li = LineInfo(1, 4, 1, 3, 6, (LineInfo.IndentType.Indent, 10))
    ...
    def test_StandardWithDedents(self):
        li = LineInfo(1, 4, 1, 3, 6, (LineInfo.IndentType.Dedent, 2))
    ...
    def test_Errors(self):
        for args in [
            (-1, 0, 0, 0, 6, None),         # Invalid offset start
            (5, 1, 0, 0, 6, None),          # Invalid offset end
            (5, 10, 2, 10, 6, None),        # Invalid startpos
            (5, 10, 5, 11, 6, None),        # Invalid endpos
            (5, 10, 6, 5, 6, None),         # Invalid startpos/endpos
            (1, 10, 2, 9, -1, None),        # Invalid indentation level
        ]:
...
class TestNormalizedContent(object):
    ...
    def test_Standard(self):
        result = NormalizedContent("hello", 5, [LineInfo(1, 4, 3, 4, 0, None)])

        assert result.Content == "hello"
        assert result.ContentLen == 5
        assert result.LineInfos == [LineInfo(1, 4, 3, 4, 0, None)]
...
class TestNormalize(object):
    ...
    def test_Simple(self):
        ...
        self.Test(
            ...
            [
                LineInfo(0, 1, 0, 1, 0, None),
                LineInfo(2, 4, 2, 4, 0, None),
                LineInfo(5, 8, 5, 8, 0, None),
            ],
        )
    ...
    def test_Indent(self):
        self.Test(
            ...
            [
                LineInfo(0, 1, 0, 1, 0, None),
                LineInfo(2, 8, 6, 8, 1, (LineInfo.IndentType.Indent, 4)),
                LineInfo(9, 20, 17, 20, 2, (LineInfo.IndentType.Indent, 8)),
                LineInfo(21, 21, 21, 21, 0, (LineInfo.IndentType.Dedent, 2)),
            ],
        )
    ...
    def test_IndentWithDedents(self):
        self.Test(
            ...
            [
                ...
                LineInfo(2, 8, 6, 8, 1, (LineInfo.IndentType.Indent, 4)),
                LineInfo(9, 20, 17, 20, 2, (LineInfo.IndentType.Indent, 8)),
                LineInfo(21, 29, 25, 29, 1, (LineInfo.IndentType.Dedent, 1)),
                LineInfo(30, 35, 30, 35, 0, (LineInfo.IndentType.Dedent, 1)),
            ],
        )
    ...
    def test_TrailingWhitespace(self):
        self.Test(
            ...
            "12  \n 34\n",
            [
                LineInfo(0, 4, 0, 2, 0, None),
                LineInfo(5, 8, 6, 8, 1, (LineInfo.IndentType.Indent, 1)),
                LineInfo(9, 9, 9, 9, 0, (LineInfo.IndentType.Dedent, 1)),
            ],
        )
    ...
    def test_EmptyLine(self):
        self.Test(
            ...
            "12\n\n34\n",
            [
                LineInfo(0, 2, 0, 2, 0, None),
                LineInfo(3, 3, 3, 3, 0, None),
                LineInfo(4, 6, 4, 6, 0, None),
            ],
        )
    ...
    def test_SpacesOnEmptyLine(self):
        self.Test(
            ...
            [
                LineInfo(0, 2, 0, 2, 0, None),
                LineInfo(3, 7, 7, 7, 0, None),
                LineInfo(8, 10, 8, 10, 0, None),
            ],
        )
    ...
    def test_SpacesOnEmptyLineWithMatchingIndent(self):
        self.Test(
            ...
            "    12\n    \n34\n",
            [
                LineInfo(0, 6, 4, 6, 1, (LineInfo.IndentType.Indent, 4)),
                LineInfo(7, 11, 11, 11, 1, None),
                LineInfo(12, 14, 12, 14, 0, (LineInfo.IndentType.Dedent, 1)),
            ],
        )
    ...
    def test_TabsVsSpaces1(self):
        self.Test(
            ...
            "1\n  2\n3\n\t4\n\t5\n\t 6\n\t 7\n",
            [
                LineInfo(0, 1, 0, 1, 0, None),                                     # 1
                LineInfo(2, 5, 4, 5, 1, (LineInfo.IndentType.Indent, 2)),          # 2
                LineInfo(6, 7, 6, 7, 0, (LineInfo.IndentType.Dedent, 1)),          # 3
                LineInfo(8, 10, 9, 10, 1, (LineInfo.IndentType.Indent, 100)),      # 4
                LineInfo(11, 13, 12, 13, 1, None),                                 # 5
                LineInfo(14, 17, 16, 17, 2, (LineInfo.IndentType.Indent, 101)),    # 6
                LineInfo(18, 21, 20, 21, 2, None),         # 7
                LineInfo(22, 22, 22, 22, 0, (LineInfo.IndentType.Dedent, 2)),
            ],
        )
    ...
    def test_TabsVsSpaces2(self):
        self.Test(
            ...
            [
                ...
                LineInfo(8, 10, 9, 10, 1, (LineInfo.IndentType.Indent, 100)),      # 4
                LineInfo(11, 13, 12, 13, 1, None),                                 # 5
                LineInfo(14, 17, 16, 17, 2, (LineInfo.IndentType.Indent, 201)),    # 6
                LineInfo(18, 21, 20, 21, 2, None),                                 # 7
                LineInfo(22, 22, 22, 22, 0, (LineInfo.IndentType.Dedent, 2)),
            ],
        )
    ...
    def test_InvalidIndentation(self):
        with pytest.raises(InvalidIndentationNormalizeError) as ex:
            Normalize(
                textwrap.dedent(
                    """\
                    1
