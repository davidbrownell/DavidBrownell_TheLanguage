...
class TestStandard(object):
    ...
    _statements                             = DynamicStatementInfo([_include_statement, _upper_statement, _lower_statement, _number_statement], [])
    ...
    # ----------------------------------------------------------------------
    def test_NoIncludeSingleThread(self):
    ...
    # ----------------------------------------------------------------------
    def test_NoIncludeMultiThread(self):
        with self.CreateObserver(
            {
                "one" : textwrap.dedent(
                    """\
    ...
    # ----------------------------------------------------------------------
    def test_SingleIncludeSingleThread(self):
        with self.CreateObserver(
            {
                "one" : textwrap.dedent(
                    """\
...
# BugBug: Add new statements
# BugBug: Circular dependencies
# BugBug: Indent and dedent
# BugBug: Terminate
