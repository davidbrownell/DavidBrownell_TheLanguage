...
class TestParseIndentAndDedent(object):
    ...
    def test_Match(self, parse_mock):
        ...
        assert MethodCallsToString(parse_mock) == textwrap.dedent(
            ...
            1, StartStatement, ['Statement', 'Ex: Word Token [0]']
            2, OnInternalStatementAsync, ['Statement', 'Ex: Word Token [0]']
            3, EndStatement, ['Statement', 'Ex: Word Token [0]']
            4, StartStatement, ['Statement', 'Ex: Newline+ [1]']
            ...
            12, EndStatement, ['Statement', 'Ex: Word Token [3]']
            13, StartStatement, ['Statement', 'Ex: Newline+ [4]']
            14, OnInternalStatementAsync, ['Statement', 'Ex: Newline+ [4]']
            15, EndStatement, ['Statement', 'Ex: Newline+ [4]']
            16, StartStatement, ['Statement', 'Ex: Word Token [5]']
            17, OnInternalStatementAsync, ['Statement', 'Ex: Word Token [5]']
            18, EndStatement, ['Statement', 'Ex: Word Token [5]']
            19, StartStatement, ['Statement', 'Ex: Newline+ [6]']
...
class TestEmbeddedStatements(object):
    ...
    def test_Match(self, parse_mock):
        ...
        assert MethodCallsToString(parse_mock) == textwrap.dedent(
            """\
            0, StartStatement, ['Statement']
            1, StartStatement, ['Statement', 'Ex: lpar [0]']
            2, OnInternalStatementAsync, ['Statement', 'Ex: lpar [0]']
            3, EndStatement, ['Statement', 'Ex: lpar [0]']
            4, StartStatement, ['Statement', 'Ex: Inner [1]']
            5, StartStatement, ['Statement', 'Ex: Inner [1]', 'Ex: Word Token [0]']
            6, OnInternalStatementAsync, ['Statement', 'Ex: Inner [1]', 'Ex: Word Token [0]']
            7, EndStatement, ['Statement', 'Ex: Inner [1]', 'Ex: Word Token [0]']
            8, StartStatement, ['Statement', 'Ex: Inner [1]', 'Ex: Word Token [1]']
            9, OnInternalStatementAsync, ['Statement', 'Ex: Inner [1]', 'Ex: Word Token [1]']
            10, EndStatement, ['Statement', 'Ex: Inner [1]', 'Ex: Word Token [1]']
            11, OnInternalStatementAsync, ['Statement', 'Ex: Inner [1]']
            12, EndStatement, ['Statement', 'Ex: Inner [1]']
            13, StartStatement, ['Statement', 'Ex: rpar [2]']
            14, OnInternalStatementAsync, ['Statement', 'Ex: rpar [2]']
            15, EndStatement, ['Statement', 'Ex: rpar [2]']
            16, OnInternalStatementAsync, ['Statement']
            17, EndStatement, ['Statement']
            """,
        )
...
class TestRepeatStatements(object):
    ...
    def test_Match4(self, parse_mock):
        ...
        assert MethodCallsToString(parse_mock) == textwrap.dedent(
            """\
            0, StartStatement, ['Statement']
            1, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]']
            2, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]', 'Rpt: Word Statement [0]']
            3, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]', 'Rpt: Word Statement [0]', 'Ex: Word Token [0]']
            4, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]', 'Rpt: Word Statement [0]', 'Ex: Word Token [0]']
            5, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]', 'Rpt: Word Statement [0]']
            6, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]']
            7, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 0, None) [0]']
            8, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]']
            9, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]']
            10, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]', 'Ex: Number Token [0]']
            11, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]', 'Ex: Number Token [0]']
            12, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]', 'Ex: Number Token [0]']
            13, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]', 'Ex: Newline+ [1]']
            14, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]', 'Ex: Newline+ [1]']
            15, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]', 'Ex: Newline+ [1]']
            16, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]']
            17, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [0]']
            18, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]']
            19, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]', 'Ex: Number Token [0]']
            20, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]', 'Ex: Number Token [0]']
            21, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]', 'Ex: Number Token [0]']
            22, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]', 'Ex: Newline+ [1]']
            23, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]', 'Ex: Newline+ [1]']
            24, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]', 'Ex: Newline+ [1]']
            25, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]']
            26, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [1]']
            27, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [2]']
            28, StartStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [2]', 'Ex: Number Token [0]']
            29, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [2]', 'Ex: Number Token [0]']
            30, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]', 'Rpt: Number Statement [2]']
            31, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]']
            32, EndStatement, ['Statement', 'Ex: Repeat: (Number Statement, 1, None) [1]']
            33, StartStatement, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]']
            34, StartStatement, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]', 'Rpt: Upper Statement [0]']
            35, StartStatement, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]', 'Rpt: Upper Statement [0]', 'Ex: Upper Token [0]']
            36, EndStatement, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]', 'Rpt: Upper Statement [0]', 'Ex: Upper Token [0]']
            37, EndStatement, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]', 'Rpt: Upper Statement [0]']
            38, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]']
            39, EndStatement, ['Statement', 'Ex: Repeat: (Upper Statement, 0, 1) [2]']
            40, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]']
            41, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]']
            42, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]', 'Ex: Word Token [0]']
            43, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]', 'Ex: Word Token [0]']
            44, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]', 'Ex: Word Token [0]']
            45, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]', 'Ex: Newline+ [1]']
            46, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]', 'Ex: Newline+ [1]']
            47, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]', 'Ex: Newline+ [1]']
            48, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]']
            49, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [0]']
            50, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]']
            51, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]', 'Ex: Word Token [0]']
            52, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]', 'Ex: Word Token [0]']
            53, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]', 'Ex: Word Token [0]']
            54, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]', 'Ex: Newline+ [1]']
            55, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]', 'Ex: Newline+ [1]']
            56, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]', 'Ex: Newline+ [1]']
            57, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]']
            58, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [1]']
            59, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]']
            60, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]', 'Ex: Word Token [0]']
            61, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]', 'Ex: Word Token [0]']
            62, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]', 'Ex: Word Token [0]']
            63, StartStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]', 'Ex: Newline+ [1]']
            64, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]', 'Ex: Newline+ [1]']
            65, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]', 'Ex: Newline+ [1]']
            66, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]']
            67, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]', 'Rpt: Word Statement [2]']
            68, OnInternalStatementAsync, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]']
            69, EndStatement, ['Statement', 'Ex: Repeat: (Word Statement, 1, None) [3]']
            70, OnInternalStatementAsync, ['Statement']
            71, EndStatement, ['Statement']
            """,
        )
...
class TestNamedStatements(object):
    ...
    @pytest.fixture
    def modified_parse_mock(parse_mock):
        parse_mock.GetDynamicStatements.side_effect = lambda unique_id, value: [TestNamedStatements._word_line_statement]
