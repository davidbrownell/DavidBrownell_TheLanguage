...
class TestStandard(object):
    ...
    def test_SingleRelativeDirectory(self):
        ...
        assert result.Children[0].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[0].Children[0].Children[0].Info.SourceFilename == self._file1
        assert result.Children[0].Children[0].Children[0].Info.ImportItems == {
            "File1" : "File1",
        }

        assert result.Children[1].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[1].Children[0].Children[0].Info.SourceFilename == self._file1
        assert result.Children[1].Children[0].Children[0].Info.ImportItems == {
            "File1" : "File1Decorated",
        }

        assert result.Children[2].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[2].Children[0].Children[0].Info.SourceFilename == self._file2
        assert result.Children[2].Children[0].Children[0].Info.ImportItems == {
            "File2" : "File2",
        }

        assert result.Children[3].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[3].Children[0].Children[0].Info.SourceFilename == self._file2
        assert result.Children[3].Children[0].Children[0].Info.ImportItems == {
            "File2" : "File2Decorated",
        }

        assert result.Children[4].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[4].Children[0].Children[0].Info.SourceFilename == self._file3
        assert result.Children[4].Children[0].Children[0].Info.ImportItems == {
            "File3" : "File3",
        }

        assert result.Children[5].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[5].Children[0].Children[0].Info.SourceFilename == self._file3
        assert result.Children[5].Children[0].Children[0].Info.ImportItems == {
            "File3" : "File3Decorated",
        }

        assert result.Children[6].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[6].Children[0].Children[0].Info.SourceFilename == self._file4
        assert result.Children[6].Children[0].Children[0].Info.ImportItems == {
            "File4" : "File4",
        }

        assert result.Children[7].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsDirectory
        assert result.Children[7].Children[0].Children[0].Info.SourceFilename == self._file4
        assert result.Children[7].Children[0].Children[0].Info.ImportItems == {
    ...
    def test_SingleRelativeFilename(self):
        ...
        assert result.Children[0].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[0].Children[0].Children[0].Info.SourceFilename == self._file1
        assert result.Children[0].Children[0].Children[0].Info.ImportItems == {
            "obj1" : "obj1",
        }

        assert result.Children[1].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[1].Children[0].Children[0].Info.SourceFilename == self._file1
        assert result.Children[1].Children[0].Children[0].Info.ImportItems == {
            "obj1" : "obj1Decorated",
        }

        assert result.Children[2].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[2].Children[0].Children[0].Info.SourceFilename == self._file2
        assert result.Children[2].Children[0].Children[0].Info.ImportItems == {
            "obj2" : "obj2",
        }

        assert result.Children[3].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[3].Children[0].Children[0].Info.SourceFilename == self._file2
        assert result.Children[3].Children[0].Children[0].Info.ImportItems == {
            "obj2" : "obj2Decorated",
        }

        assert result.Children[4].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[4].Children[0].Children[0].Info.SourceFilename == self._file3
        assert result.Children[4].Children[0].Children[0].Info.ImportItems == {
            "obj3" : "obj3",
        }

        assert result.Children[5].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[5].Children[0].Children[0].Info.SourceFilename == self._file3
        assert result.Children[5].Children[0].Children[0].Info.ImportItems == {
            "obj3" : "obj3Decorated",
        }

        assert result.Children[6].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[6].Children[0].Children[0].Info.SourceFilename == self._file4
        assert result.Children[6].Children[0].Children[0].Info.ImportItems == {
            "obj4" : "obj4",
        }

        assert result.Children[7].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[7].Children[0].Children[0].Info.SourceFilename == self._file4
        assert result.Children[7].Children[0].Children[0].Info.ImportItems == {
            "obj4" : "obj4Decorated",
        }
    ...
    def test_SingleAbsoluteFilename(self):
        ...
        assert result.Children[0].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[0].Children[0].Children[0].Info.SourceFilename == self._root_file1
        assert result.Children[0].Children[0].Children[0].Info.ImportItems == {
            "obj1" : "obj1",
        }

        assert result.Children[1].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[1].Children[0].Children[0].Info.SourceFilename == self._root_file1
        assert result.Children[1].Children[0].Children[0].Info.ImportItems == {
            "obj1" : "obj1Decorated",
        }

        assert result.Children[2].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[2].Children[0].Children[0].Info.SourceFilename == self._root_file2
        assert result.Children[2].Children[0].Children[0].Info.ImportItems == {
            "obj2" : "obj2",
        }

        assert result.Children[3].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[3].Children[0].Children[0].Info.SourceFilename == self._root_file2
        assert result.Children[3].Children[0].Children[0].Info.ImportItems == {
            "obj2" : "obj2Decorated",
        }

        assert result.Children[4].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[4].Children[0].Children[0].Info.SourceFilename == self._root_file3
        assert result.Children[4].Children[0].Children[0].Info.ImportItems == {
            "obj3" : "obj3",
        }

        assert result.Children[5].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[5].Children[0].Children[0].Info.SourceFilename == self._root_file3
        assert result.Children[5].Children[0].Children[0].Info.ImportItems == {
            "obj3" : "obj3Decorated",
        }

        assert result.Children[6].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[6].Children[0].Children[0].Info.SourceFilename == self._root_file4
        assert result.Children[6].Children[0].Children[0].Info.ImportItems == {
            "obj4" : "obj4",
        }

        assert result.Children[7].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[7].Children[0].Children[0].Info.SourceFilename == self._root_file4
        assert result.Children[7].Children[0].Children[0].Info.ImportItems == {
            "obj4" : "obj4Decorated",
        }
    ...
    def test_Grouping(self):
        ...
        assert result.Children[1].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[1].Children[0].Children[0].Info.SourceFilename == self._file2
        assert result.Children[1].Children[0].Children[0].Info.ImportItems == {
            "obj3" : "obj3Decorated",
            "obj4" : "obj4",
            "obj5" : "obj5Decorated",
    ...
    def test_TrailingCommas(self):
        ...
        assert result.Children[2].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[2].Children[0].Children[0].Info.SourceFilename == self._file3
        assert result.Children[2].Children[0].Children[0].Info.ImportItems == {
            "obj3" : "obj3Decorated",
        }

        assert result.Children[3].Children[0].Children[0].Info.ImportType == ImportStatement.ImportType.SourceIsModule
        assert result.Children[3].Children[0].Children[0].Info.SourceFilename == self._file4
        assert result.Children[3].Children[0].Children[0].Info.ImportItems == {
            "obj4" : "obj4",
            "obj5" : "obj5",
        }
