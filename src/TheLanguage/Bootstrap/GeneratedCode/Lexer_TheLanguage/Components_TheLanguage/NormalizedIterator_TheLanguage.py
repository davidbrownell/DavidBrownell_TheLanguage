...
class NormalizedIterator(object):
    ...
    def _InternalInit(self, args, kwargs):
        # _content, _offset, _line_info_index, _consumed_dedent_line, _consumed_dedent_count
        ...
        self._Init_97f00d33e8cf4c9baa716b230550963f_()
    ...
    def _Init_97f00d33e8cf4c9baa716b230550963f_(self):
        pass
    ...
    @staticmethod
    def Create(content, ):
        return NormalizedIterator(NormalizedContentEx.Create(content, ), 0, 0, None, None, )
    ...
    # Return Type: Tuple(HashBytes, UIntArch, <UIntArch | None>, <UIntArch | None>)
    def ToCacheKey(self):
        return (self.Hash(), self.OffsetProper(), self._consumed_dedent_line.Clone(), self._consumed_dedent_count.Clone(), )
    ...
    def Advance(self, delta, ):
        ...
        if offset == line_info.offset_end:
            ...
            assert (offset >= line_info.content_start or (offset == line_info.offset_start and (offset + delta == line_info.content_start or delta == line_info.offset_end - line_info.offset_start))), "We are looking at content (A), at the beginning of the line and are skipping the whitespace prefix (B) or are skipping the entire line (C)"
    ...
    class NormalizedContentEx(NormalizedContent):
        ...
        def _InternalInit(self, args, kwargs):
            ...
            self._Init_4377e03c45a34f6f8024e49f9dd2df35_()
        ...
        # Return Type: None
        def _Init_4377e03c45a34f6f8024e49f9dd2df35_(self):
    ...
    def Clone(self):
        return self.__class__(self._content, self._offset, self._line_info_index, self._consumed_dedent_line, self._consumed_dedent_count)
