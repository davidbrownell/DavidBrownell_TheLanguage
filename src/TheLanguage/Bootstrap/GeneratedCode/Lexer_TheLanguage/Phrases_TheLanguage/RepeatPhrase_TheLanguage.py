...
class RepeatPhrase(Phrase):
    ...
    def _InternalInit(self, args, kwargs):
        ...
        self._Init_65f6511f3b1243fe878f4c1ec6364297_()
    ...
    def Lex(self, unique_id, iter, observer, ignore_whitespace=False, ):
        ...
        if len(results) >= self.min_matches:
            ...
            result = LexResult(True, NormalizedIteratorRange(original_iter, iter, ), PhraseLexResultData(self, PhraseContainerLexResultData(results, is_complete=True, ), unique_id, error_result.data if error_result is not None else None, ), )
        ...
        return LexResult(False, NormalizedIteratorRange(original_iter, iter, ), PhraseLexResultData(self, PhraseContainerLexResultData(results, is_complete=True, ), unique_id, ), )

    # Return Type: None
    def _Init_65f6511f3b1243fe878f4c1ec6364297_(self):
