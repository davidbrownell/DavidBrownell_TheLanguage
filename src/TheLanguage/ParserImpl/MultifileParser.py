...
class Observer(Interface.Interface):
    ...
    def OnStatementComplete(
        ...
        Optional[DynamicStatementInfo],             # DynamicStatementInfo generated by the statement (if necessary)
...
def Parse(
    ...
    class ThreadInfo(object):
        ...
        source_pending: Dict[str, List[threading.Event]]
...
class _StatementsObserver(StatementsObserver):
    ...
    @Interface.override
    def OnIndent(self):
        return self._observer.OnIndent(self._fully_qualified_name)

    # ----------------------------------------------------------------------
    @Interface.override
    def OnDedent(self):
        return self._observer.OnDedent(self._fully_qualified_name)
