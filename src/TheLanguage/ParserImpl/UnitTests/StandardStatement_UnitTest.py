...
class TestListStatements(object):
    ...
    # ----------------------------------------------------------------------
    def test_MatchWord(self, execution_mock):
        execution_mock.OnInternalStatement = Mock(return_value=True)
        ...
        assert execution_mock.OnIndent.call_count == 0
        assert execution_mock.OnDedent.call_count == 0
        assert execution_mock.OnInternalStatement.call_count == 2

        assert execution_mock.OnInternalStatement.call_args_list[0][0][0].Statement == self._word_statement
        assert execution_mock.OnInternalStatement.call_args_list[0][0][1].Offset == 0
        assert execution_mock.OnInternalStatement.call_args_list[0][0][2].Offset == 4

        assert execution_mock.OnInternalStatement.call_args_list[1][0][0].Statement == self._newline_statment
        assert execution_mock.OnInternalStatement.call_args_list[1][0][1].Offset == 4
        assert execution_mock.OnInternalStatement.call_args_list[1][0][2].Offset == 5
    ...
    # ----------------------------------------------------------------------
    def test_MatchNumber(self, execution_mock):
        result = self._statement.Parse(
            NormalizedIterator(
                Normalize(
                    textwrap.dedent(
        ...
        assert execution_mock.OnInternalStatement.call_args_list[0][0][0].Statement == self._number_statement
        assert execution_mock.OnInternalStatement.call_args_list[0][0][1].Offset == 0
        assert execution_mock.OnInternalStatement.call_args_list[0][0][2].Offset == 8

        assert execution_mock.OnInternalStatement.call_args_list[1][0][0].Statement == self._newline_statment
        assert execution_mock.OnInternalStatement.call_args_list[1][0][1].Offset == 8
        assert execution_mock.OnInternalStatement.call_args_list[1][0][2].Offset == 9
