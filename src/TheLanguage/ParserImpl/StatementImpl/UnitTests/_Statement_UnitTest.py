...
# ----------------------------------------------------------------------
class TestRepeatAcrossDedent(object):
    """A dedent should break any active repeat cycle"""

    _name_token                             = RegexToken("Name", re.compile(r"(?P<value>[a-zA-Z]+)"))
    _colon_token                            = RegexToken("':'", re.compile(r":"))
        ...
        (
            Statement(
                ...
                (
                    Statement(
                        "Line",
                        RegexToken("Line Token", re.compile(r"(?P<value>[^\n]*)")),
                        NewlineToken(),
                    ),
                    1,
                    None,
    ...
    # ----------------------------------------------------------------------
    def test_SingleStatementSingleLine(self, parse_mock):
        result = self._statement.Parse(
            NormalizedIterator(
                Normalize(
                    textwrap.dedent(
        ...
        assert str(result) == textwrap.dedent(
            ...
            True
            32
                Name <<Regex: <_sre.SRE_Match object; span=(0, 5), match='outer'>>> ws:None [1, 1 -> 1, 6]
                ':' <<Regex: <_sre.SRE_Match object; span=(5, 6), match=':'>>> ws:None [1, 6 -> 1, 7]
                Newline+ <<6, 7>> ws:None [1, 7 -> 2, 1]
                Indent <<7, 11, (4)>> ws:None [2, 1 -> 2, 5]
                Repeat: (Inner, 1, None)
                    Inner
                        Name <<Regex: <_sre.SRE_Match object; span=(11, 16), match='inner'>>> ws:None [2, 5 -> 2, 10]
                        ':' <<Regex: <_sre.SRE_Match object; span=(16, 17), match=':'>>> ws:None [2, 10 -> 2, 11]
                        Newline+ <<17, 18>> ws:None [2, 11 -> 3, 1]
                        Indent <<18, 26, (8)>> ws:None [3, 1 -> 3, 9]
                        Repeat: (Line, 1, None)
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(26, 31), match='line1'>>> ws:None [3, 9 -> 3, 14]
                                Newline+ <<31, 32>> ws:None [3, 14 -> 4, 1]
                        Dedent <<>> ws:None [4, 1 -> 4, 1]
                Dedent <<>> ws:None [4, 1 -> 4, 1]
            """,
        )
    ...
    # ----------------------------------------------------------------------
    def test_SingleStatementMultipleLine(self, parse_mock):
        result = self._statement.Parse(
            NormalizedIterator(
                Normalize(
                    textwrap.dedent(
                    ...
                    Inner
                        ...
                        Repeat: (Line, 1, None)
                            Line
                                ...
                                Newline+ <<31, 32>> ws:None [3, 14 -> 4, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(40, 53), match='line2 is here'>>> ws:None [4, 9 -> 4, 22]
                                Newline+ <<53, 54>> ws:None [4, 22 -> 5, 1]
    ...
    # ----------------------------------------------------------------------
    def test_MultiStatementSingleLine(self, parse_mock):
        result = self._statement.Parse(
            NormalizedIterator(
                Normalize(
                    textwrap.dedent(
        ...
        assert str(result) == textwrap.dedent(
            ...
            60
                ...
                Repeat: (Inner, 1, None)
                    Inner
                        Name <<Regex: <_sre.SRE_Match object; span=(11, 17), match='innerA'>>> ws:None [2, 5 -> 2, 11]
                        ':' <<Regex: <_sre.SRE_Match object; span=(17, 18), match=':'>>> ws:None [2, 11 -> 2, 12]
                        Newline+ <<18, 19>> ws:None [2, 12 -> 3, 1]
                        Indent <<19, 27, (8)>> ws:None [3, 1 -> 3, 9]
                        Repeat: (Line, 1, None)
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(27, 32), match='line1'>>> ws:None [3, 9 -> 3, 14]
                                Newline+ <<32, 34>> ws:None [3, 14 -> 5, 1]
                        Dedent <<>> ws:None [5, 1 -> 5, 5]
                    Inner
                        Name <<Regex: <_sre.SRE_Match object; span=(38, 44), match='innerB'>>> ws:None [5, 5 -> 5, 11]
                        ':' <<Regex: <_sre.SRE_Match object; span=(44, 45), match=':'>>> ws:None [5, 11 -> 5, 12]
                        Newline+ <<45, 46>> ws:None [5, 12 -> 6, 1]
                        Indent <<46, 54, (8)>> ws:None [6, 1 -> 6, 9]
                        Repeat: (Line, 1, None)
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(54, 59), match='line2'>>> ws:None [6, 9 -> 6, 14]
                                Newline+ <<59, 60>> ws:None [6, 14 -> 7, 1]
                        Dedent <<>> ws:None [7, 1 -> 7, 1]
                Dedent <<>> ws:None [7, 1 -> 7, 1]
            """,
        )
    ...
    # ----------------------------------------------------------------------
    def test_MultiStatementMultiLine(self, parse_mock):
        result = self._statement.Parse(
            NormalizedIterator(
                Normalize(
                    textwrap.dedent(
                ...
                Repeat: (Inner, 1, None)
                    Inner
                        ...
                        Repeat: (Line, 1, None)
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(27, 32), match='line1'>>> ws:None [3, 9 -> 3, 14]
                                Newline+ <<32, 33>> ws:None [3, 14 -> 4, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(41, 55), match='this is line 2'>>> ws:None [4, 9 -> 4, 23]
                                Newline+ <<55, 57>> ws:None [4, 23 -> 6, 1]
                        Dedent <<>> ws:None [6, 1 -> 6, 5]
                    Inner
                        Name <<Regex: <_sre.SRE_Match object; span=(61, 67), match='innerB'>>> ws:None [6, 5 -> 6, 11]
                        ':' <<Regex: <_sre.SRE_Match object; span=(67, 68), match=':'>>> ws:None [6, 11 -> 6, 12]
                        Newline+ <<68, 69>> ws:None [6, 12 -> 7, 1]
                        Indent <<69, 77, (8)>> ws:None [7, 1 -> 7, 9]
                        Repeat: (Line, 1, None)
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(77, 91), match='this is line 3'>>> ws:None [7, 9 -> 7, 23]
                                Newline+ <<91, 92>> ws:None [7, 23 -> 8, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(100, 104), match='more'>>> ws:None [8, 9 -> 8, 13]
                                Newline+ <<104, 105>> ws:None [8, 13 -> 9, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(113, 118), match='lines'>>> ws:None [9, 9 -> 9, 14]
                                Newline+ <<118, 119>> ws:None [9, 14 -> 10, 1]
                        Dedent <<>> ws:None [10, 1 -> 10, 1]
                Dedent <<>> ws:None [10, 1 -> 10, 1]
            """,
        )
    ...
    # ----------------------------------------------------------------------
    def test_BlankLines(self, parse_mock):
        result = self._statement.Parse(
            NormalizedIterator(
                Normalize(
                    textwrap.dedent(
                    ...
                    Inner
                        ...
                        Repeat: (Line, 1, None)
                            Line
                                ...
                                Newline+ <<32, 34>> ws:None [3, 14 -> 5, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(42, 56), match='this is line 2'>>> ws:None [5, 9 -> 5, 23]
                                Newline+ <<56, 58>> ws:None [5, 23 -> 7, 1]
                        Dedent <<>> ws:None [7, 1 -> 7, 5]
                    Inner
                        Name <<Regex: <_sre.SRE_Match object; span=(62, 68), match='innerB'>>> ws:None [7, 5 -> 7, 11]
                        ':' <<Regex: <_sre.SRE_Match object; span=(68, 69), match=':'>>> ws:None [7, 11 -> 7, 12]
                        Newline+ <<69, 70>> ws:None [7, 12 -> 8, 1]
                        Indent <<70, 78, (8)>> ws:None [8, 1 -> 8, 9]
                        Repeat: (Line, 1, None)
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(78, 92), match='this is line 3'>>> ws:None [8, 9 -> 8, 23]
                                Newline+ <<92, 93>> ws:None [8, 23 -> 9, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(101, 105), match='more'>>> ws:None [9, 9 -> 9, 13]
                                Newline+ <<105, 108>> ws:None [9, 13 -> 12, 1]
                            Line
                                Line Token <<Regex: <_sre.SRE_Match object; span=(116, 121), match='lines'>>> ws:None [12, 9 -> 12, 14]
                                Newline+ <<121, 122>> ws:None [12, 14 -> 13, 1]
                        Dedent <<>> ws:None [13, 1 -> 13, 1]
                Dedent <<>> ws:None [13, 1 -> 13, 1]
            """,
        )
