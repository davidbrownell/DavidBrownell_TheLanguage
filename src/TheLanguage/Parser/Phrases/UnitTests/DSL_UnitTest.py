...
class TestParseSimple(object):
    ...
    async def test_SingleSpaceSep(self, parse_mock):
        ...
        assert str(result.IterE) == "[2, 1] (8)", "The result iterator should be modified"
    ...
    async def test_MultipleSpaceSep(self, parse_mock):
        ...
        result = await self._phrase.ParseAsync(["root"], iter, parse_mock)
        assert str(iter) == "[1, 1] (0)", "The incoming iterator should not be modified"
        assert str(result.IterE) == "[2, 1] (13)", "The result iterator should be modified"
    ...
    async def test_MultiTabSep(self, parse_mock):
        ...
        result = await self._phrase.ParseAsync(["root"], iter, parse_mock)
        assert str(iter) == "[1, 1] (0)",  "The incoming iterator should not be modified"
        assert str(result.IterE) == "[2, 1] (9)", "The result iterator should be modified"
    ...
    async def test_MultipleTrailingSpace(self, parse_mock):
        ...
        result = await self._phrase.ParseAsync(["root"], iter, parse_mock)
        assert str(iter) == "[1, 1] (0)",  "The incoming iterator should not be modified"
        assert str(result.IterE) == "[2, 1] (12)", "The result iterator should be modified"
    ...
    async def test_MultipleLines(self, parse_mock):
        ...
        assert str(result.IterE) == "[3, 1] (19)", "The result iterator should be modified"
    ...
    async def test_TrailingWhitespace(self, parse_mock):
        ...
        result = await self._phrase.ParseAsync(["root"], iter, parse_mock)
        assert str(iter) == "[1, 1] (0)",  "The incoming iterator should not be modified"
        assert str(result.IterE) == "[5, 1] (17)", "The result iterator should be modified"
    ...
    async def test_NoMatch(self, parse_mock):
        ...
        result = await self._phrase.ParseAsync(["root"], iter, parse_mock)
        assert str(iter) == "[1, 1] (0)",  "The incoming iterator should not be modified"
        assert str(result.IterE) == "[1, 8] (7)", "The result iterator should be modified"
