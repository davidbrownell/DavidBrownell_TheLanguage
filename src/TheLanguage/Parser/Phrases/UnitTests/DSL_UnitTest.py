...
# ----------------------------------------------------------------------
class TestSingleNonGreedy(object):
    _phrase                                 = CreatePhrase(
        name="Phrase",
        item=[
            PhraseItem(
    ...
    # ----------------------------------------------------------------------
    @pytest.mark.asyncio
    async def test_WithOptional(self, parse_mock):
        result = await self._phrase.ParseAsync(
            ["root"],
            CreateIterator(
                textwrap.dedent(
    ...
    # ----------------------------------------------------------------------
    @pytest.mark.asyncio
    async def test_WithOutOptional(self, parse_mock):
        result = await self._phrase.ParseAsync(
            ["root"],
            CreateIterator(
                textwrap.dedent(
...
# ----------------------------------------------------------------------
class TestMultipleNonGreedy(object):
    _phrase                                 = CreatePhrase(
        name="Phrase",
        item=[
            PhraseItem(
                name="Optional Word 1",
                item=_word_token,
                arity="?-",
            ),
            _word_token,
            PhraseItem(
                name="Optional Word 2",
                item=_word_token,
                arity="?-",
            ),
            NewlineToken(),
    ...
    # ----------------------------------------------------------------------
    @pytest.mark.asyncio
    async def test_Full(self, parse_mock):
        result = await self._phrase.ParseAsync(
            ["root"],
            CreateIterator(
                textwrap.dedent(
    ...
    # ----------------------------------------------------------------------
    @pytest.mark.asyncio
    async def test_TwoWords(self, parse_mock):
        result = await self._phrase.ParseAsync(
            ["root"],
            CreateIterator(
                textwrap.dedent(
    ...
    # ----------------------------------------------------------------------
    @pytest.mark.asyncio
    async def test_OneWord(self, parse_mock):
        result = await self._phrase.ParseAsync(
            ["root"],
            CreateIterator(
                textwrap.dedent(
